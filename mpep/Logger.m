classdef Logger < handle
    ...
    methods
        ...
        function start(self, series, exp, params, comment)
            ...
            fileStr = [self.animal '\' num2str(series) '\' num2str(exp) '\' self.animal '_' num2str(series) '_' num2str(exp)];
            self.write(['Starting Series ' num2str(series) ' Exp ' num2str(exp) ' (File ' fileStr '). ' comment]);
            str = '';
